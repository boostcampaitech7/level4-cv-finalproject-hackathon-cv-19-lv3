...
def get_difference_dict(target_landmarks_json_path, compare_landmarks_json_path):
    ...
    # print("################ HEAD ################")
    # print("고개가 숙여진/펴진 정도: ", pose1.get_head_angle())
    # print("시선이 오른/왼쪽으로 얼마나 돌아갔는지: ", pose1.get_eye_direction())
    
    # print("################ BODY ################")
    # print("허리가 앞으로 숙여진 정도: ", pose1.get_waist_angle())
    # print("사용자 몸이 돌아간 정도: ", pose1.get_body_direction())

    # print("################ LEFT ARM ################")
    # print("왼팔 굽혀진 정도 : ", pose1.get_left_elbow_angle())
    # print("왼팔 높이: ", pose1.get_left_arm_height())
    # print("왼팔 방향: ", pose1.get_left_arm_dir())

    # print("################ RIGHT ARM ################")
    # print("오른팔 굽혀진 정도 : ", pose1.get_right_elbow_angle())
    # print("오른팔 높이: ", pose1.get_right_arm_height())
    # print("오른팔 방향: ", pose1.get_right_arm_dir())

    # print("################ LEFT LEG ################")
    # print("왼다리 굽혀진 정도 : ", pose1.get_left_knee_angle())
    # print("왼다리 높이: ", pose1.get_left_leg_height())
    # print("왼다리 방향: ", pose1.get_left_leg_dir())

    # print("################ RIGHT LEG ################")
    # print("오른다리 굽혀진 정도 : ", pose1.get_right_knee_angle())
    # print("오른다리 높이: ", pose1.get_right_leg_height())
    # print("오른다리 방향: ", pose1.get_right_leg_dir())
