...
def calculate_similarity_with_visualization(real_keypoints1, real_keypoints2, normalize_keypoints1, normalize_keypoints2):
    ...
    for idx1, idx2 in pairs:
        ...
        kp1 = normalize_keypoints1[idx1]  # shape: (keypoint_count, 3)
        kp2 = normalize_keypoints2[idx2]  # shape: (keypoint_count, 3)
        ...
        for p1, p2 in zip(kp1, kp2):
            ...
            # 유클리드 유사도 계산
            euclidean_similarity = np.exp(-1 * abs(euclidean(p1, p2)))
